...
function getCountry(name) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, axios_1.default)("https://restcountries.com/v2/name/".concat(name))];
                case 1:
                    getApi = _a.sent();
                    data = getApi.data[0];
                    return [2 /*return*/, {
...
function getRegionCapitals(capital) {
    return __awaiter(this, void 0, void 0, function () {
        var countries, promises, arr, capitals, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getRegionCountries(capital)];
                case 1:
                    countries = _a.sent();
                    promises = countries.map(function (country) {
                        return (0, axios_1.default)("https://restcountries.com/v2/name/".concat(country));
                    });
